...
import { FavoriteBorderRounded, KeyboardArrowDownRounded, LocalShippingOutlined, Person2Outlined, PlaceOutlined, ShoppingCartRounded } from "@mui/icons-material";
...
const Navbar = ({ search, setSearch, data }) => {
  ...
  // const handleSearch = () => {
  //   if (search.trim() !== "") {
  //     toggleModal(); // Toggle modal state when search is performed
  //   }
  // };
      ...
      <nav id="navbar" className="w-full">
        ...
        >
          <div className="flex justify-between items-center gap-8">
            ...
            <div id="search-bar">
              {/* Pass necessary props to Searchbar */}
              <Searchbar
                setSearch={setSearch}
                search={search}
                data={data}
