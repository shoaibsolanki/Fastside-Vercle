    ...
    <div className="my-4">
      ...
      >
        ...
        <section className="w-[548px] flex flex-row items-start justify-start py-0 px-px box-border max-w-full">
          <div className="flex-1 flex flex-row items-start justify-between py-0 px-[89px] box-border max-w-full gap-[20px] mq450:pl-5 mq450:pr-5 mq450:box-border mq600:flex-wrap mq600:pl-11 mq600:pr-11 mq600:box-border">
            <Placeholder image={keychain} semicolons="3" />
            <Placeholder image={Lanyard} semicolons="2" />
            <Placeholder image={keychain} semicolons="1" />
          </div>
        </section>
